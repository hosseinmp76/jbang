...
See `link:https://github.com/jbangdev/jbang-examples/tree/master/examples/jfx.java[]` and `link:https://github.com/jbangdev/jbang-examples/tree/master/examples/jfxtiles.java[]` for examples of this.
